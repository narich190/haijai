                            ...
                            <div class="filterbox" style="width:100%;">
                              ...
                              <div class="filter-box">
                                <div class="form-group"  style="width:50%;display:inline-block;float:left;">
                                  ...
                                  <select class="form-control" name='project_type' id='requestprojectFilter_project_type' style="width:70%;float:left;" >
                                ...
                                <div class="form-group"  style="width:50%;display:inline-block;float:left;">
                                  ...
                                  <select class="form-control" name='project_group_projectgroup_id' id='requestprojectFilter_project_group_projectgroup_id' style="width:70%;float:left;">
                              ...
                              <script type="text/javascript">
                                ...
                                $(document).ready(function(){
                                  ...
                                  $requestprojectFilter_project_type = "<?=($this->session->userdata('requestprojectFilter_project_type_ssession')!=''? $this->session->userdata('requestprojectFilter_project_type_ssession'):'')?>";
                                  $requestprojectFilter_project_group_projectgroup_id = "<?=($this->session->userdata('requestprojectFilter_project_group_projectgroup_id_ssession')!=''? $this->session->userdata('requestprojectFilter_project_group_projectgroup_id_ssession'):'')?>";

                                  if($requestprojectFilter_project_type != '' && $requestprojectFilter_project_group_projectgroup_id != ''){
                                    
                                    $("select#requestprojectFilter_project_type option").each(function() { this.selected = (this.value == $requestprojectFilter_project_type); });
                                    $("select#requestprojectFilter_project_group_projectgroup_id option").each(function() { this.selected = (this.value == $requestprojectFilter_project_group_projectgroup_id); });
