...
<html lang="en">
<!--header-->
<header class="firstpage" style="width:100%;height:calc(50% - 90px);min-height:120px;background:url('<?=base_url()?>assets/img/project/projectbg2.png') no-repeat center center fixed; 
...
<div class="overviewproject" style="width:100%;min-height:1000px;background:#FFFFFF;padding:2% 8% 0% 4%;">
	...
	<div class="col-sm-12" style="padding:0%;width:100%;">
		...
		echo "<span style='color:white;font-size:16;'>".$value['project_preview']."</span>
				<br><br>
				<a href='".base_url()."project/detailactivity/".$value['project_id']."'><button class='btn btn-primary'>ดูเพิ่มเติม</button></a>
			</div>
			<a href='#'>
