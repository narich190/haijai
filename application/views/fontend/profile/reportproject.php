		    			...
		    			<div class='col-sm-12'>
							...
							<div class='progress'>
  								<div class='progress-bar progress-bar-info' role='progressbar' aria-valuenow=".$value['projectpercen']."aria-valuemin='0' aria-valuemax='100' style='width:".$value['projectpercen']."%'>
  									<span style='color:#333333'>".$value['projectpercen']."%  </span>
 								</div>
							</div>
						</div>
					</div>
		...
		<div class="col-sm-12" >
			...
			<div style="overflow:auto;width:100%;height:100%;background:#C4D3E3;">
				...
				<?=form_open_multipart("manageproblem/adminresponse");?>
					...
					<input type="hidden" class="actionmain" name="actionmain" value='profile/reportproject'/>
					...
					<div style="width:100%;background:white;">
						...
						<div class="col-sm-12" style="border-style: solid;border-width: 1px;padding:5px;">
							<button class="form-control btn btn-warning" style="width:100%;">ส่งรายงาน</button>
						</div>
					</div>
				</div>
				<?=form_close();?>
...
<script type="text/javascript">
	...
	function getReportProjectdata($project_id){
		
		$.ajax({
	      url: "http://localhost/haijai/project/getReportProjectdata",
	      type:"POST",
	      cache:false,
	      data:{
